...
class PKAnalyzer extends mysqli
{
    private $PKeys = array();
    ...
    {
        $this->PKDMLFunctionParameters .= "\$" . $pk . ",";
        $this->PKDMLFunctionParametersDefaultNull .= "\$" . $pk . "=NULL,";
        $this->PKDMLFunctionParametersIsNotNull .= "!empty(\$" . $pk . ") && ";
        $this->PKParametersDocumentation .= "\t* @param " . $this->getType($pkType) . " \$" .  $pk . "\n";
        $this->PKAttributeIsNotNull .= "!empty(\$this->" . $pk . ") && ";
        $this->PKForUpdateCurrent .= "\$this->" . $pk . ",";
    }
