...
class EntityBuilder
{
    ...
    /**
     * @var SimpleTemplate The template engine used by the builder for managing the generated source code
     */
    private $source;
    ...
    public function __construct($tableName, $pkName, $className)
    {
        ...
        $this->source = new SimpleTemplate(__DIR__ . "/EntityClass.tpl");
    }

    /**
     * Builds a section of the source code defined into the PhpHeader block of the used template
     * See the template file BeanClass.php.tpl for details of the generated code
     */
     ...
     * See the template file BeanClass.php.tpl for details of the generated code
     * @param FieldToAttributeReflection $attribute the attribute object
     */
    public function buildPkAttribute(FieldToAttributeReflection $attribute)
    {
     ...
     * @param FieldToAttributeReflection $attribute the attribute object
     */
    public function buildAttribute(FieldToAttributeReflection $attribute)
    {
     ...
     */
    public function buildConstructorForMultiplePk(PKAnalyzer $analyzer)
    {
     ...
     * @param FieldToAttributeReflection $attribute the attribute object
     */
    public function buildSetter(FieldToAttributeReflection $attribute)
    {
     ...
     * @param FieldToAttributeReflection $attribute the attribute object
     */
    public function buildGetter(FieldToAttributeReflection $attribute)
    {
     ...
     * @param PKAnalyzer $analyzer
     */
    public function buildSelectMethodForMultiplePk($fieldsResultSet,PKAnalyzer $analyzer)
    {
        // Loop for initializing attributes
    ...
    private function initField($dbObject,$template)
    {
        ...
        $this->source->setVar("Attribute",FieldToAttributeReflection::underscoreToCamelCase($dbObject->Field));
     ...
     * @param PKAnalyzer $analyzer
     */
    public function buildDeleteMethodForMultiplePk(PKAnalyzer $analyzer)
    {
     ...
     * @param PKAnalyzer $analyzer
     */
    public function buildInsertMethodForMultiplePk($fields,$values, PKAnalyzer $analyzer)
    {
     ...
     * @param PKAnalyzer $analyzer
     */
    public function buildUdateMethodForMultiplePk($fieldsEqualValues,PKAnalyzer $analyzer)
    {
     ...
     * @param PKAnalyzer $analyzer
     */
    public function buildUpdateCurrentMethodForMultiplePk($tableName,PKAnalyzer $analyzer)
    {
     ...
     * @param FieldToAttributeReflection $attribute the attribute object
     */
    private function setAttributeValues(FieldToAttributeReflection $attribute)
    {
