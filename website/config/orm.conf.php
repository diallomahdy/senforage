...
/**
 * Defines lenght of subustring for TableReflection::buildUptateFileldsEqualValues()
 * Linux=-6, Wndows =-7
 */
 ...
 */
define ("CLASS_PARENT","EntityCore");


/**
 *  Includes
 */
include_once(__DIR__ . '/../orm/mapping/SchemaReflection.php');
include_once(__DIR__ . '/../orm/mapping/TableReflection.php');
include_once(__DIR__ . '/../orm/mapping/FieldToAttributeReflection.php');
include_once(__DIR__ . '/../orm/mapping/EntityBuilder.php');
include_once(__DIR__ . '/../orm/mapping/SimpleTemplate.php');
include_once(__DIR__ . '/../orm/mapping/PKAnalyzer.php');
